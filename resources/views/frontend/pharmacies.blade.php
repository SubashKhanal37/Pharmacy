...
@section('main-container')
    <div class="col-12">
        <div class="bg-light rounded h-100 mt-2 p-4">
            ...
            <a href="{{ route('pharmacies.create') }}"><button class="btn btn-primary"><i class="fa fa-edit"
                        aria-hidden="true"></i>Add Pharmacy</button></a>
            <br><br>
            <div class="table-responsive">
                <table class="table text-center table-borderless" style="align-items: center" id="table">
                    <thead>
                        <tr>
